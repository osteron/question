# Виселица
#
# Классическая игра "Виселица" - компьютер случайным образом выбирает слово, которое игрок должен отгадать
# буква за буквой. Если игрок не сумеет отгадать за отведенное количество попыток, на экране появится фигурка
# повешенного.
import random
HANGMAN = (
    """
